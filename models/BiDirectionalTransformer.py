...
class BiDirectionalTransformer(nn.Module):
    ...
    def __init__(self, num_joints, joint_dim, input_dim, embedding_dim=32, nhead=12, num_encoder_layers=6, dim_feedforward=2048, dropout=0.1, batch_first=True):
        super().__init__()
        ...
        # Define Modules
        self.joint_embedder = JointEmbedding(self.num_joints, self.joint_dim, self.embedding_dim, self.dropout)
        ...
        self.output_layer = nn.Linear(self.embedding_dim * self.num_joints, self.num_joints * self.joint_dim)
